...
public void OnPluginStart() 
{
	...
	{
		case Engine_CSGO, Engine_CSS, Engine_SourceSDK2006: LoadTranslations("lr_module_defuser.phrases");
...
void ConfigLoad()
{
	...
	KeyValues hLRDefuser = new KeyValues("Defuser");

	if(!hLRDefuser.ImportFromFile(sPath))
		SetFailState(PLUGIN_NAME ... " : File is not found (%s)", sPath);

	g_iLevel = hLRDefuser.GetNum("rank", 0);
